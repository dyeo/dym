...
#define GMTK_SWZ4_OP(op)																					\
	vec<4, T> operator op (const swizzle4<a, b, c, d, T> &s) const											\
	{																										\
		vec<4, T> res(static_cast<T>(0));																	\
	...
	vec<4, T> operator op (const swizzle4<a2, b2, c2, d2, T> &s) const										\
	{																										\
		vec<4, T> res(static_cast<T>(0));																	\
		...
		return res;																							\
																											...
																											\
	vec<4, T> operator op (const T &v) const																\
	{																										\
		vec<4, T> res(static_cast<T>(0));																	\
		...
		return res;																							\
																											...
																											\
	friend vec<4, T> operator op (const T &l, const swizzle4<a, b, c, d, T> &r)								\
	{																										\
		vec<4, T> res(static_cast<T>(0));																	\
...
#define GMTK_SWZ4_ROP(op)																					\
	writable_type &operator op (const swizzle4<a, b, c, d, T> &s)											\
	{																										\
		...
		return *this;																						\
																											...
																											\
	template<int a2, int b2, int c2, int d2, typename T>													\
	writable_type &operator op (const swizzle4<a2, b2, c2, d2, T> &s)										\
	{																										\
		...
		return *this;																						\
																											...
																											\
	writable_type &operator op (const vec<4, T> &s)															\
	{																										\
...
#define GMTK_SWZ4_BOP(op)																					\
	...
	static inline vec<4, T> operator op (const vec<4, T> &v, const swizzle4<a, b, c, d, T> &s)				\
	{ 																										\
		vec<4, T> res; 																						\
...
#define GMTK_SWZ4_BROP(op)																					\
	template<int a, int b, int c, int d, typename T>														\
	static inline vec<4, T> &operator op (vec<4, T> &v, const swizzle4<a, b, c, d, T> &s)					\
	{ 																										\
		v.data[0] op s[a]; 																					\
		v.data[1] op s[b]; 																					\
		v.data[2] op s[c]; 																					\
...
#define GMTK_SWZ4_TYPE \
	template<int a, int b, int c, int d> using swz4 = swizzle4<a, b, c, d, T>;
...
{////
	...
	public:
		...
		typedef typename std::conditional<is_writable, swizzle4<a, b, c, d, T>, struct duplicate_components_swizzle>::type writable_type;
	...
	template <int a, int b, int c, int d, typename T>
	inline std::ostream &operator<<(std::ostream& os, const swizzle4<a, b, c, d, T>& s)
	{
